...
public static class ParseUtility
{
    ...
    public static List<Post>? ScrapePage(Creator creator, int page, int numberOfPostsToGet)
    {
        ...
        var asset = HttpManager.GET(creator.URL + $"?o={page * 50}", httpVersion: HttpManager.HttpVersionNumber.Http3);
        ...
        if (postsContainer != null)
            if (postsContainer.ChildNodes != null)
                foreach (var postobj in HtmlManager.FetchChildNodes(postsContainer))
                {
                    ...
                    var postWebResponse =
                        HttpManager.GET(compiledPost.URL, httpVersion: HttpManager.HttpVersionNumber.Http3);
                    ...
                    compiledPost.Id = long.Parse(postId).ToString();
